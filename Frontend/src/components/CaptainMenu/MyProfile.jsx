  ...
  const updateProfilePicture = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/captains/update-profile-picture`,
        formData,
        {
          headers: {
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        <div className="flex flex-col items-center">
          ...
          <div className="relative group">
            <img
              src={ props.userData?.captain?.ProfilePicture}
              alt="Profile Picture"
          ...
          <div className="mt-6 text-center">
            <div className="flex items-center justify-center gap-2">
              <h2 className="text-2xl font-bold text-center text-gray-900">
                {props.userData?.captain?.fullname?.firstname}{" "}
                {props.userData?.captain?.fullname?.lastname}
              </h2>
            ...
            <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-900">{props.userData?.captain?.email}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-900">{props.userData?.captain?.mobileNumber}</p>
                </div>
              </div>
            </div>
